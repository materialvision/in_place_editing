module InPlaceMacrosHelper
  ...
  # <tt>:highlight_color</tt>::   Background colour when hovering
  # <tt>:highlightend_color</tt>::Background colour after hovering
  ...
  def in_place_editor(field_id, options = {})
    ...
    js_options['highlightEndColor'] = %('#{options[:highlightend_color]}') if options[:highlightend_color] 
